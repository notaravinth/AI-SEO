    ...
    <nav className='fixed top-0 left-0 w-full px-8 py-5'>
      <div className='flex items-center justify-center gap-10'>
        ...
        <div className='center-items space-x-6 text-white border border-gray-600 border-rounded rounded-full px-6 py-3 backdrop-blur-md'>
          ...
          <a href="#Developer" className='hover:text-gray-300'>Developers</a>
        ...
        <button>
          ...
          <div className='text-white border border-purple-500 rounded-xl px-2 py-1 bg-gradient-to-b from-purple-500 to-purple-900 cursor-pointer'>
            <span>
              Join Waitlist
            </span>
          </div>
